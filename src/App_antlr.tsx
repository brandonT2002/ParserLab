...
import { runParser } from "./service/runParser";

type Tab = "lexer" | "parser";

function Antlr(): JSX.Element {
    const [activeTab, setActiveTab] = useState<Tab>("lexer");

    const [lexerCode, setLexerCode] = useState<string>("// Lexer ANTLR");
    const [parserCode, setParserCode] = useState<string>("// Parser ANTLR");
                ...
                <div className="h-full flex flex-col">
                    <div className="flex mb-2">
                        ...
                        <button 
                            ...
                            onClick={() => {
                                try {
                                    const result = runParser(lexerCode)
                                    console.log(result);
                                } catch (err) {
